...
import { CommunityUserListRequestDto } from "./dto/community-list.dto";
import { CommunityUserListResponseDto } from "./dto/data/community-list-data.dto";
import { CommunityUserCreateRequestDto } from "./dto/community-create.dto";
import { CommunityUserUpdateRequestDto } from "./dto/community-update.dto";
...
export class CommunityController {
    ...
    @ApiStdResponses({
        ...
        okDataDto: CommunityUserListResponseDto,
        requestBodyDtos: [CommunityUserListRequestDto],
    })
    async getList(
        @Body() dto: CommunityUserListRequestDto,
    ...
    @ApiStdResponses({
        ...
        requestBodyDtos: [CommunityUserCreateRequestDto],
    })
    async createPost(
        @Body() dto: CommunityUserCreateRequestDto,
        @Token([UserType.USER, UserType.PARTNER]) token:any)
    {
    ...
    @ApiStdResponses({
        ...
        okExampleCode: 'SUCCESS',
        okExampleMessage: '요청 성공',
        requestBodyDtos: [CommunityUserUpdateRequestDto],
    })
    async updatePost(
        @Body() dto: CommunityUserUpdateRequestDto,
        @Token([UserType.USER, UserType.PARTNER]) token:any    
    ) {
