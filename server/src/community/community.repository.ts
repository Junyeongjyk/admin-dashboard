...
import { CommunityUserListItem, EventBannerItem } from "./dto/data/community-list-data.dto";
...
export class CommunityRepository {
    ...
    async findByFilterList(type:string, filter:string|undefined, keyword:string|undefined): Promise<CommunityUserListItem[]> {
    ...
    async findById(id: number): Promise<CommunityUserListItem | undefined> {
