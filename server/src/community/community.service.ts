...
export class CommunityService {
    ...
    async getList(dto: CommunityUserListRequestDto, token:any) {
        try {
    ...
    async createPost(dto: CommunityUserCreateRequestDto, token:any) {
        try {
    ...
    async updatePost(dto: CommunityUserUpdateRequestDto, token:any) {
        try {
